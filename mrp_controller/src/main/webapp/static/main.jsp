...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            async: false,
            data: {adminId: ${sessionScope.user.isAdmin}},
            dataType: "json",
            success: function (data) {

                // var arr = data.urlLists;
                // for(var i=0;i<data.urlLists.length;i++){
                //     var name=arr[i];
                //     alert(name)
                //     var itemsr = "<li><a class='J_menuItem'  href='"+name+"' target='J_menuItem'>主页示例二</a></li>"
                //     $(".addUrl").append(itemsr)
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="img/logo01.ico"/></span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong
                                       class="font-bold">欢迎您:${sessionScope.user.name}</strong></span>
                                <span class="text-muted text-xs block">${sessionScope.user.nickname}<b
                                        class="caret"></b></span>
                                </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            ...
                            <li class="divider"></li>
                            <li><a href="${pageContext.request.contextPath}/login/loginUserOut">安全退出</a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level addUrl">
                        <li>
                            <a class="J_menuItem" href="index_v1.html" data-index="0">主页示例一</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="dmylogin.html">主页示例二</a>
                        </li>
                        <%--                            <%--%>
                        <%--                                String listUrl = (String) request.getSession().getAttribute("listUrl");--%>
                        <%--                            %>--%>
                        ${sessionScope.ss}
                        <c:forEach var="nameItem" items="${sessionScope.ss}">
                            <li>
                                <a class="J_menuItem" href="${nameItem.menuUrl}"/>
                                    ${nameItem.menuName}
                                </a>
                            </li>
                        </c:forEach>
                        ...
                        <%--                            </li>--%>
                        <%--                            <li>--%>
                        <%--                                <a class="J_menuItem" href="item">商品类目</a>--%>
                        <%--                            </li>--%>
                        <%--                            <li>--%>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="${pageContext.request.contextPath}/login/loginUserOut" class="roll-nav roll-right J_tabExit"><i
                    class="fa fa fa-sign-out"></i> 退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <!--                此处修改主页欢迎-->
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="dmylogin.html?v=4.0" frameborder="0"
                    data-id="index_v2.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2020-2021 <a href="http://www.zi-han.net/" target="_blank">an's blog</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
